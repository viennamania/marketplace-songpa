...
import {
  nftDropContractAddressTRVC,
  stakingContractAddressTRVC,
...
import NFTCard from '../nft-trvc/NFTCard';
    ...
    try {
      const transaction =
        await contractMarketplace?.directListings.createListing({
          assetContractAddress: nftDropContractAddressTRVC, // Contract Address of the NFT
    ...
    <>
      <ParamTab tabMenu={tabMenu}>
        <TabPanel className="focus:outline-none  ">
          <h2 className="flex justify-center ">Your Staked TRVCs</h2>
          ...
          <h2 className="mt-10 flex justify-center">Your Unstaked TRVCs</h2>
            ...
            {ownedNfts?.map((nft) => (
              ...
              >
                ...
                <div className="flex flex-row gap-2">
                  <Web3Button
                    theme="light"
                    contractAddress={stakingContractAddressTRVC}
                    action={() => stakeNft(nft.metadata.id)}
                  >
                    Rent to Racetrack
                  </Web3Button>
