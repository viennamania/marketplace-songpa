  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <Image src={logo} alt={name} width={500} height={500} priority className='rounded-lg'/>
      </div>
...
interface AssetSliderProps {
  coins: AssetCardProps[];
}

export default function CoinSlider({ coins }: AssetSliderProps) {
